...
* **Pygame** - Biblioteca para desenvolvimento da interface gráfica, eventos e áudio.
* **SQLite3** - Banco de dados relacional embutido para persistência dos recordes de pontuação.
